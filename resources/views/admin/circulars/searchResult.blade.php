...
<div id="messageTable" class="col-md-offset-3 col-md-6 col-sm-12 col-xs-12">
    ...
    <div id="tableHeading" class="col-md-12 col-sm-12 col-xs-12">
        <h4>These are all the files i could find admin ({{count($searchResults)}})</h4>
    </div>
            ...
            <tr>
                ...
                <td data-column="Actions">
                    ...
                    <form style="margin-top:15px;" action="{{'/disable-circular/'.$searchResult->id}}" method="post">
                        {{csrf_field()}} {{method_field('PUT')}}
                        <button type="submit" class="btn btn-warning">Disable Circular</button>
                    </form>
                    @endif
                    <form style="margin-top:15px;" action="{{'/delete-circular/'.$searchResult->id}}" method="post">
