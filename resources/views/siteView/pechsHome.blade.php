@extends('layouts.homePageLayout') @section('head') @endsection @section('body')
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>The site is still under development.
          ...
          <br>
          <b>
            <u>Future Implimentations Include</u>
          </b>
          <br>
  ...
  <div id="topPart" class="col col-md-12 col-sm-12 col-xs-12">
    ...
    <div id="topCarousel" class="carousel slide" data-ride="carousel">
      ...
      <ol class="carousel-indicators">
        ...
        @if(count($slider)>1) @for($i=1; $i
        <count($slider); $i++) <li data-target="#topCarousel" data-slide-to="{{$i}}">
          </li>
          @endfor @endif
      </ol>
      ...
      <div id="largeDisplayCarousel">
        <div id="announcementLargeDisplayCarousel" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            ...
            @for ($i = 3; $i
            < count($update); $i=$i+3) <div class="item">
              <div class="row">
                <div class="col-md-12 carousel-contnet myText">
                  @if($i
                  < count($update)) <div class="individualAnnouncement col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <p>{{$update[$i]->title}}
                      <a href="/view-announcement-details/{{$update[$i]->id}}">Read More</a>
                    </p>
                </div>
                @endif @if($i+1
                < count($update)) <div id="individualAnnouncement" class="individualAnnouncement col-lg-4 col-md-4 col-sm-4 col-xs-4">
                  <p>{{$update[$i+1]->title}}
...
-->
    ...
    <div class="showBox" id="aboutValencia" style="display: none; padding: 0px 15px 0px 15px">
      <div class="aboutUsContentDetail well">
        <p>Valancia Cooperative Housing society is a gated community located on Defence Road adjacent to Wapda Town. It is named
          after the city Valencia, Spain. Valancia was planned in the 1990s and started construction under the funding from
          Mashreq Bank. It is notable for its well-landscaped boulevards connecting a balanced mix of single-family detached
          homes, community and shopping centers. Valancia also has an extensive system of paved pathways with grade separations
          over and under the boulevards. Valancia's residential areas are separated into Blocks. Each Block has its own dedicated
...
-->
 ...
 -->
        ...
        <div id="higherLvlMembers" class="col col-md-12 col-sm-12 col-xs-12">
          <div id="firstLevel" class="col-md-12 col-sm-12 col-xs-12 levels">
            <div class="col-md-10 col-md-offset-3">
              @for($i=0; $i
              <count($committe); $i++) @if($committe[$i]->position=='1')
                <!-- 1 = President -->
                ...
                @endif @endfor @for($i=0; $i
                <count($committe); $i++) @if($committe[$i]->position=='2')
                  <!-- 3 = Secretary -->
          ...
          <div id="secondLevel" class="col-md-12 col-sm-12 col-xs-12 levels">
            @for($i=0; $i
            <count($committe); $i++) @if($committe[$i]->position=='3')
              <!-- 2 = Vice President -->
              <div class="col col-md-4 col-sm-6 col-xs-12">
                <div class="card">
                  <img src={{ asset( 'storage/myAssets/MC/'.$committe[$i]->imgpath) }}>
              ...
              @endif @endfor @for($i=0; $i
              <count($committe); $i++) @if($committe[$i]->position=='4')
                <!-- 4 = Joint Secretary -->
                <div class="col col-md-4 col-sm-6 col-xs-12">
                  <div class="card">
                    <img src={{ asset( 'storage/myAssets/MC/'.$committe[$i]->imgpath) }}>
                ...
                @endif @endfor @for($i=0; $i
                <count($committe); $i++) @if($committe[$i]->position=='5')
                  <!-- 5 = Finance Secretary -->
                  <div class="col col-md-4 col-sm-6 col-xs-12">
                    <div class="card">
                      <img src={{ asset( 'storage/myAssets/MC/'.$committe[$i]->imgpath) }}>
        ...
        <div id="thirdLevel" class="col col-md-12 col-sm-12 col-xs-12 levels">
          @for($i=0; $i
          <count($committe); $i++) @if($committe[$i]->position=='6')
            <!-- 6 = Executive -->
...
-->
    <div class="showBox" id="focal" style="display: none;">
      <div class="aboutUsContentDetail">
        ...
        <div id="focalMembers" class="col col-md-12 col-sm-12 col-xs-12">
          @for($i=0; $i
          <count($focal); $i++) <div class="col col-md-3 col-sm-6 col-xs-12">
            <div class="card">
  ...
  <div class="showBox" id="map" style="display: none;">
    <div class="aboutUsContentDetail">
      <center></center>
      <a href="storagestorage/myAssets/valenciaMap.jpg" target="_blank">
        <img src="storagestorage/myAssets/valenciaMap.jpg">
      </a>
      </center>
    </div>
  </div>
    ...
    <div class="aboutUsContentDetail">
      ...
      <div id="achievementsCarousel" class="carousel slide" data-ride="carousel">
        ...
        <ol class="carousel-indicators">
          ...
          @if(count($achievement)>1) @for($i=1; $i
          <count($achievement); $i++) <li data-target="#achievementsCarousel" data-slide-to="{{$i}}">
            </li>
            @endfor @endif
        </ol>
        ...
        <div class="carousel-inner">
          ...
          @if(count($achievement)>1) @for($i=1; $i
          <count($achievement); $i++) <div class="item">
            <div class="carousel-caption">
  ...
  <div class="aboutUsContentDetail">
    ...
    <div id="projectsCarousel" class="carousel slide" data-ride="carousel">
      ...
      <ol class="carousel-indicators">
        ...
        @if(count($project)>1) @for($i=1; $i
        <count($project); $i++) <li data-target="#projectsCarousel" data-slide-to="{{$i}}">
          </li>
          @endfor @endif
      </ol>
      ...
      <div class="carousel-inner">
        ...
        @if(count($project)>1) @for($i=1; $i
        <count($project); $i++) <div class="item">
          <div class="carousel-caption">
  ...
  <div class="aboutUsContentDetail">
    ...
    <div id="galleryCarousel" class="carousel slide" data-ride="carousel">
      ...
      <ol class="carousel-indicators">
        ...
        @if(count($galleryImage)>1) @for($i=1; $i
        <count($galleryImage); $i++) <li data-target="#galleryCarousel" data-slide-to="{{$i}}">
          </li>
          @endfor @endif
      </ol>
      ...
      <div class="carousel-inner">
        ...
        @if(count($galleryImage)>1) @for($i=1; $i
        <count($galleryImage); $i++) <div class="item">
          <div class="carousel-caption">
...
<div id="bottomPart" class="col col-md-12 col-sm-12 col-xs-12">
  <p>
    ...
    Jquery
    <br>
    <a href="/documentation" target="_blank">Click To know more about the project</a>
    <br>
    <b>
